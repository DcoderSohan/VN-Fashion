          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              ...
              <div className="flex justify-center mb-5">
                <div className="w-14 h-14 border border-gray-200 bg-[#f9f8f6] flex items-center justify-center">
                  <AlertCircle size={26} className="text-black" />
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <button
                  onClick={onClose}
                  className="px-8 py-2.5 bg-black text-white text-[10px] font-medium tracking-[0.16em] uppercase hover:bg-gray-800 transition-all duration-200"
                >
                  Dismiss
                </button>
              </div>
